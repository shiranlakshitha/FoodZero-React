    ...
    <div className="">
      <div className="bg-[#233000] h-[1800px] px-[50px]">
        <div className="pt-[50px] relative w-full h-auto lg:h-[750px]">
          ...
          className="max-md:py-[50px] max-lg:text-center absolute top-0 left-0 max-w-[1000px] z-60 text-white">
            <h1
               
            className="font-rufina max-lg:mt-[35px] text-[80px] max-sm:text-[60px] md:text-[100px] lg:text-[140px] leading-tight  ">
              Healthy Eating is important part of lifestyle
            </h1>
            <p
              
              className="mt-[25px] font-lato text-lg max-md:self-center w-full lg:max-w-[500px] "
            >
          ...
          <div className="absolute hidden lg:flex flex-row gap-[25px] z-30 bottom-[-50px] right-[350px]">
            ...
            src={assets.spices1} className="w-[150px]" alt="" />
            <motion.img
              src={assets.spices2}
              className="w-[150px]"
              alt=""
        ...
        <div className=" py-[25px] lg:mt-[150px] flex gap-5  flex-row max-md:flex-col justify-around">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="flex flex-col items-start flex-2/3"
          >
            <img
              src={assets.heroimg2}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="flex max-md:flex-col-reverse flex-col flex-1/3"
          >
      ...
      <div className="flex flex-col h-auto lg:h-[710px] md:flex-row py-[100px] pt-[50px] px-[50px] bg-[#EBF0E4] gap-5 relative">
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="flex-1 items-center mx-auto mt-[25px] lg:ml-[100px] ">
      ...
      <div className="text-center px-[50px] py-[50px]">
        <motion.h1
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-5xl font-semibold  font-rufina text-black"
        >
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="mt-[35px] font-lato max-w-[600px] mx-auto"
        >
